...
// @Component({
//   selector: 'app-matriculas-egresadas',
//   standalone: true,
//   imports: [CommonModule, RouterModule],
//   templateUrl: './matricula-egresadas.html',
//   styleUrl: './matricula-egresadas.scss'
// })
// export class MatriculasEgresadas implements OnInit {
...
//         this.matriculasService.listar('EGRESADO').toPromise(),
...
//     } catch (error) {
//       console.error('Error al cargar matrículas egresadas:', error);
//       this.errorMsg = 'No se pudo cargar la lista de matrículas egresadas.';
//     } finally {
//       this.loading = false;
//       this.cd.detectChanges();
//     }
