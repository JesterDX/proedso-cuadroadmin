...
private apiUrl =
'[https://proedso-back-wtdl.onrender.com/api/matriculas](https://proedso-back-wtdl.onrender.com/api/matriculas)';
...
previsualizarCuotas(
payload: {
plan\_curso\_id: number;
fecha\_matricula: string;
monto\_total?: number | null;
cuota\_inicial?: number | null;
}
): Observable {
...
this.estadosAlumnoService
  ...
  .subscribe({
    ...
    error: (err: any) => {
      ...
      console.error(
        'Error al cargar estados de alumno:',
        err
      );
...
/*
 * IMPORTANTE:
 * En edición no llamamos primero a actualizarSelectorMaquinas()
 * porque ese método limpia las máquinas seleccionadas.
 */

this.configurarSelectorMaquinasSinLimpiar();
...
this.matriculasService
  ...
  .subscribe({
    ...
    error: (err) => {
      ...
      console.error(
        'Error al cargar máquinas de la matrícula:',
        err
      );
...
// ==========================================================
// CONFIGURAR SELECTOR EN EDICIÓN
// ==========================================================

private configurarSelectorMaquinasSinLimpiar(): void {
...
// ==========================================================
// VERIFICAR MÁQUINA SELECCIONADA
// ==========================================================
