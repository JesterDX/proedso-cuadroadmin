...
this.form.monto\_total ?? null;

this.previewCuotaInicial =
this.form.cuota\_inicial ?? null;
...
console.log(
'🌐 URL:',
'[https://proedso-back-wtdl.onrender.com/api/matriculas/previsualizar-cuotas](https://proedso-back-wtdl.onrender.com/api/matriculas/previsualizar-cuotas)'
);

console.log('📦 PAYLOAD:', payload);
console.log('📋 PLAN:', payload.plan\_curso\_id);
console.log('📅 FECHA MATRÍCULA:', payload.fecha\_matricula);
console.log('💰 MONTO TOTAL:', payload.monto\_total);
console.log('💵 CUOTA INICIAL:', payload.cuota\_inicial);
console.log('📆 MODALIDAD:', payload.modalidad\_pago);
console.log('🚜 MÁQUINAS:', payload.maquinas\_seleccionadas);
