...
// @Component({
//   selector: 'app-matriculas-retiradas',
//   standalone: true,
//   imports: [CommonModule, RouterModule],
//   templateUrl: './matriculas-retiradas.html',
//   styleUrl: './matriculas-retiradas.scss'
// })
// export class MatriculasRetiradas implements OnInit {
...
//     Promise.all([
//       this.matriculasService.listar('RETIRADO').toPromise(),
//       this.alumnosService.listar('', true).toPromise(),
//       this.planesCursoService.listar().toPromise()
//     ])
//       .then(([matriculasResp, alumnosResp, planesResp]: any[]) => {
...
//       .catch((error) => {
//         console.error(error);
//         this.errorMsg = 'No se pudo cargar la lista de matrículas retiradas.';
//       })
//       .finally(() => {
//         this.loading = false;
//         this.cd.detectChanges();
